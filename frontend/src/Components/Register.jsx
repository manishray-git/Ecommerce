...
import registersideimage from '../images/registersideimage.jpg'
...
export default function Register() {
    ...
    const signup = (event) => {
        ...
        axiosClient
            ...
            .catch((error) => {
                const { validator_err } = error.response.data;
                setErrors(validator_err);
            });
    };
    ...
    return (
        <div className="h-screen md:flex">
            ...
            <img src={registersideimage} className="absolute h-full w-full"></img>
                <div>
